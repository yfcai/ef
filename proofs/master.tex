...
\label{eq:subapps}
\end{align}
Since constraints in $D$ were hauled around piggybacked, the type
variables $\alpha$~and $\beta$ occurs nowhere else.\footnote{
It would be hard to formulate ``$\alpha$~and $\beta$ occurs
nowhere else '' in Agda, I guess.
%
}%

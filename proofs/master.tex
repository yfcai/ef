...
Nonemptiness and downward closedness are unused in the type
soundness proof. It might be fun to set the denotation of types
to arbitrary subsets of $V-\{\Wrong\}$ and look at the ensuing
monstrosities, one of which being that nothing could then be
allowed to have the type $\All\alpha\alpha$, not even primitives.

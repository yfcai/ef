...
\andalso x\notin\Gamma\andalso\FTV(\sigma_1)\subseteq\Delta}
...
\infrule[CT-0]
{\emptyset;\emptyset\vdash t:\sigma\Given\emptyset\andalso
t,\sigma\text{ closed}}
{t:\sigma}

\infrule[CT-Var]
{x:\sigma\in\Gamma}
{\Gamma;\Delta\vdash x:\sigma\Given\emptyset}

\infrule[CT-Abs]
{x:\sigma_1,\Gamma;\Delta\vdash t:\sigma_2\Given C
\andalso x\notin\Gamma\andalso\FTV(\sigma_1)\subseteq\Delta}
{\Gamma;\Delta\vdash\Abs{x:\sigma}t\Given C : \sigma_1\R\sigma_2}

\infrule[CT-App]
{\Gamma;\Delta\vdash t_1:\sigma_1\Given C_1
\andalso\Gamma;\Delta\vdash t_2:\sigma_2\Given C_2
\andalso\alpha,\beta\notin\Delta
}
{\Gamma;\alpha,\beta,\Delta\vdash t_1~t_2:\beta
\Given\sigma_1\le\alpha\R\beta,\sigma_2\le\alpha,C_1\cup C_2
}

\infrule[CT-Tabs]
{
\begin{array}[b]{r@{\;}l}
\alpha,\Delta;\beta_1\in I_1,\ldots,\beta_n\in I_n&\vdash C\\
\Gamma;\alpha,\beta_1,\ldots,\beta_n,\Delta&\vdash
t:\sigma\Given C
\end{array}
\andalso
\alpha,\beta_1,\ldots,\beta_n\notin\Delta\cup\FTV(\Gamma)
}
{\Gamma;\Delta\vdash\Tabs\alpha t :
...
\infrule[S-Vacuous]
{}
{\Delta;\emptyset\vdash\emptyset}

\infrule[S-Refl]
{\Delta;E\vdash C}
{\Delta;E\vdash\sigma\le\sigma,C}

\infrule[S-Arrow]
{\Delta;E\vdash \sigma_2\le\sigma_0,\sigma_1\le\sigma_3,C}
{\Delta;E\vdash \sigma_0\R\sigma_1\le\sigma_2\R\sigma_3,C}

\infrule[S-Union]
{\Delta;E\vdash \sigma_1\le\sigma_3,\sigma_2\le\sigma_3,C}
{\Delta;E\vdash \sigma_1\cup\sigma_2\le\sigma_3,C}

\infrule[S-Intersect]
{\Delta;E\vdash \sigma_1\le\sigma_2,\sigma_1\le\sigma_3,C}
{\Delta;E\vdash \sigma_1\le\sigma_2\cap\sigma_3,C}

\infrule[S-L0]
{
\Delta;\alpha\in I,E\vdash \sigma_1\le\sigma_2,C
\andalso
\text{$\alpha$ is only free in $\sigma_1$}
}
{\Delta;E\vdash(\All\alpha\sigma_1)\le\sigma_2,C}
...
{\Delta;E\vdash(\All{\alpha\in I}\sigma_1)\le\sigma_2,C}

\infrule[S-R]
{
\alpha,\Delta;E\vdash\sigma_1\le\sigma_2,C
\andalso
\text{$\alpha$ is only free in $\sigma_2$}
}
...
\begin{array}[b]{r@{\;}l}
\Delta;E&\vdash
\{\sigma_i\le\sigma_j\Or-m\le i\le-1\text{ and }1\le j\le n\}\cup C
\\

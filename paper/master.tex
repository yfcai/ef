...
\emph{definedness} partial order $\Sub$ on $V$ satisfying the
...
well-definedness of recursive algebraic data types.
...
\]
The proof goal follows from antisymmetry of the definedness
partial order $\Sub$.

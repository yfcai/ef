...
\infrule[T-Abs]
{x:\sigma_1,\Gamma\vdash t:\sigma_2
\andalso x\notin\Gamma}
...
The CT-judgement $\Gamma\vdash t:\sigma\Given C$
abbreviates:
\begin{quotation}
For every type environment $\Env$ and every $\env\in\Sem\Gamma~\Env$,
If
...
\]
for each $\rho_i\le\sigma_i\in C$, then
\[
\Sem t~\env\ \in\ \Sem\sigma~\Env.
\]
\end{quotation}
...
\begin{quotation}
There exist type environments compatible with~$E$. If $\Env$ is
compatible with $E$, then for each $\rho\le\sigma\in C$ we have
\[
...
\infrule[CT-Abs]
{x:\sigma_1,\Gamma\vdash t:\sigma_2\Given C
\andalso x\notin\Gamma}
{\Gamma\vdash\Abs{x:\sigma}t\Given C : \sigma_1\R\sigma_2}
...
\infrule[S-Refl]
{E\vdash C}
{E\vdash\sigma\le\sigma,C}

\infrule[S-Arrow]
{E\vdash \sigma_2\le\sigma_0,\sigma_1\le\sigma_3,C}
{E\vdash \sigma_0\R\sigma_1\le\sigma_2\R\sigma_3,C}

\infrule[S-Union]
{E\vdash \sigma_1\le\sigma_3,\sigma_2\le\sigma_3,C}
{E\vdash \sigma_1\cup\sigma_2\le\sigma_3,C}

\infrule[S-Intersect]
{E\vdash \sigma_1\le\sigma_2,\sigma_1\le\sigma_3,C}
{E\vdash \sigma_1\le\sigma_2\cap\sigma_3,C}

\infrule[S-L0]
{
\alpha\in I,E\vdash \sigma_1\le\sigma_2,C
\andalso
\text{$\alpha$ is only free in $\sigma_1$}
}
{E\vdash(\All\alpha\sigma_1)\le\sigma_2,C}

\infrule[S-L1:Fixme]
{
\alpha\in [\sigma_3\cup\sigma_4,\sigma_5\cap\sigma_6],E\vdash
\sigma_1\le\sigma_2,C
\andalso
\text{$\alpha$ is only free in $\sigma_1$}
}
{E\vdash(\All{\alpha\in [\sigma_3,\sigma_5]}\sigma_1)\le\sigma_2,C}

\infrule[S-R]
{
E\vdash\sigma_1\le\sigma_2,C
\andalso
\text{$\alpha$ is only free in $\sigma_2$}
}
{E\vdash\sigma_1\le(\All\alpha\sigma_2),C}
